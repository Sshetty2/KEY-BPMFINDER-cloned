...
// this script utilizes the chrome alarm api to listen for an alarm. Once the alarm is fired, a message is logged to the console and chrome's storage api is queried once again. 'status' in chrome's local storage object is set to 0 and the 'disabled' attribute of the 'button' is removed so that it can be clickable once again and another message indicating the status of the alarm and the current state of local storage is logged to the console.
